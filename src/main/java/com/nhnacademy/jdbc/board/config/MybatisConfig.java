...
public class MybatisConfig {
    ...
    public DataSource dataSource(){
        ...
        basicDataSource.setUrl("jdbc:mysql://133.186.211.156:3306/nhn_academy_5");
        basicDataSource.setUsername("nhn_academy_5");
        basicDataSource.setPassword("1Nv@Fbn6IU94!8EJ");
